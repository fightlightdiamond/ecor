Tính năng core Xác thực & Quản lý tài khoản
...
🧱 Nhóm 1: Tính năng cốt lõi (Tự xây bằng Filament Core - 100% miễn phí)
Bạn có thể tạo ra Resource "Bài viết" chỉ với vài dòng lệnh, và người dùng cuối sẽ có ngay các tính năng sau:
...
* Quản lý Tác giả:
    * Tự động lưu người dùng nào đang tạo bài viết (created_by).
    * Cho phép quản trị viên gán bài viết cho một tác giả khác.

🧩 Nhóm 2: Tính năng nâng cao từ Plugin miễn phí
Để có hệ thống bài viết chuyên nghiệp như WordPress mà không phải code lại từ đầu, bạn dùng các plugin miễn phí sau:
📸 1. Quản lý Hình ảnh & Media (Plugin: Awcodes Curator)
...
🏷️ 2. Quản lý Danh mục & Thẻ chuyên sâu
...
🔍 3. Quản lý SEO (Plugin: BezhanSalleh/filament-google-analytics hoặc tự thêm field)
* Mặc dù chưa có plugin SEO chuyên sâu miễn phí, nhưng bạn có thể dễ dàng thêm các trường nhập vào form bài viết:
...
📋 5. Quản lý thành phần tĩnh (Pages & Menus) - Plugin: TomatoPHP Filament CMS
...
* Dùng plugin Activity Log hoặc Auditing:
