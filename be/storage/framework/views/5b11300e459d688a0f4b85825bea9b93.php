        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            <div class="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a href="<?php echo e(route('storefront.shop')); ?>" class="inline-flex justify-center items-center px-8 py-4 text-lg font-bold text-white bg-indigo-600 rounded-full shadow-xl shadow-indigo-500/30 hover:bg-indigo-700 hover:shadow-indigo-500/50 hover:-translate-y-1 transition-all duration-300">
                        Mua Ngay
...
<section id="categories" class="mb-24 container mx-auto px-4">
    <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
        ...
        <a href="<?php echo e(route('storefront.shop')); ?>" class="text-indigo-600 font-bold hover:text-indigo-800 flex items-center">
            Xem Tất Cả Danh Mục
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <!-- Category Card -->
        <a href="<?php echo e(route('storefront.shop', ['search' => 'Xanh'])); ?>" class="relative group h-80 rounded-[2rem] overflow-hidden shadow-xl shadow-slate-200/50 block">
        ...
        <a href="<?php echo e(route('storefront.shop', ['search' => 'Đen'])); ?>" class="relative group h-80 rounded-[2rem] overflow-hidden shadow-xl shadow-slate-200/50 block">
        ...
        <a href="<?php echo e(route('storefront.shop', ['search' => 'Thảo'])); ?>" class="relative group h-80 rounded-[2rem] overflow-hidden shadow-xl shadow-slate-200/50 block sm:col-span-2 lg:col-span-1">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="group flex flex-col bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/40 shadow-xl shadow-slate-200/40 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 overflow-hidden relative">
                ...
                <div class="absolute top-4 left-4 z-10 flex flex-col gap-2">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->stock < 10 && $product->stock > 0): ?>
                ...
                <div class="relative overflow-hidden aspect-square bg-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($product->getFeatureImageUrl()): ?>
                        <img src="<?php echo e($product->getFeatureImageUrl()); ?>" alt="<?php echo e($product->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700">
                    <?php else: ?>
                    ...
                    <div class="absolute inset-0 bg-slate-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4 backdrop-blur-[2px]">
                        <button onclick="addToCart(<?php echo e($product->id); ?>)" class="p-4 bg-white text-indigo-600 rounded-full shadow-xl hover:bg-indigo-600 hover:text-white transition-colors transform translate-y-4 group-hover:translate-y-0 duration-300 tooltip" title="Thêm vào giỏ">
                        ...
                        <a href="<?php echo e(route('storefront.product', $product->slug)); ?>" class="p-4 bg-white text-slate-700 rounded-full shadow-xl hover:bg-slate-800 hover:text-white transition-colors transform translate-y-4 group-hover:translate-y-0 duration-300 delay-75" title="Xem chi tiết">
                ...
                <div class="p-6 flex flex-col flex-1">
                    <a href="<?php echo e(route('storefront.product', $product->slug)); ?>">
                        <h3 class="text-xl font-bold text-slate-900 mb-2 leading-snug group-hover:text-indigo-600 transition-colors line-clamp-2"><?php echo e($product->name); ?></h3>
                    </a>
                    <!-- Rating Stars (Mock) -->
                    ...
                    <div class="mt-auto flex items-center justify-between">
                        <div class="text-2xl font-black text-indigo-600">$<?php echo e(number_format($product->price, 2)); ?></div>
                    </div>
                </div>
            </div>
...
<section class="mb-24 container mx-auto px-4">
    <div class="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
        ...
        <a href="<?php echo e(route('storefront.blog')); ?>" class="text-indigo-600 font-bold hover:text-indigo-800 flex items-center">
            Đọc Tất Cả Bài Viết
            <svg class="w-5 h-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" /></svg>
        </a>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $latestPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('storefront.post', $post->slug)); ?>" class="group flex flex-col bg-white/80 backdrop-blur-md rounded-[2rem] border border-white/40 shadow-xl shadow-slate-200/50 hover:-translate-y-2 hover:shadow-2xl transition-all duration-300 overflow-hidden">
                <div class="relative overflow-hidden aspect-[4/3]">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($post->getFirstMediaUrl('feature_image')): ?>
                        <img src="<?php echo e($post->getFirstMediaUrl('feature_image')); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover bg-slate-100 group-hover:scale-110 transition-transform duration-700">
                    <?php else: ?>
                ...
                <div class="p-8 flex flex-col flex-1">
                    <h3 class="text-2xl font-bold text-slate-900 mb-3 leading-snug group-hover:text-indigo-600 transition-colors line-clamp-2"><?php echo e(is_array($post->title) ? ($post->title[app()->getLocale()] ?? current($post->title)) : $post->title); ?></h3>
                    <div class="text-slate-500 line-clamp-2 mb-6"><?php echo e(is_array($post->short_description) ? ($post->short_description[app()->getLocale()] ?? current($post->short_description)) : $post->short_description); ?></div>
...
<?php echo $__env->make('layouts.storefront', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/storefront/home.blade.php ENDPATH**/ ?>