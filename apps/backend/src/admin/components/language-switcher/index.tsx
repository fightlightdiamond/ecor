...
/**
 * Bộ chuyển đổi ngôn ngữ cho Medusa Admin — component dùng chung.
 *
 ...
 * luôn nằm ở góc trên bên phải màn hình (khu vực header).
 *
 * Cách dùng:
 * - Trang core Medusa: mount qua widget `src/admin/widgets/language-switcher.tsx`
 *   (đăng ký các zone `.before`).
 * - Trang custom route (cards, campaign-posts, media...): widget zone không
 *   chạy trên custom route, nên phải render trực tiếp `<LanguageSwitcher />`
...
const LanguageSwitcher = () => {
  ...
  const control = (
    <div className="fixed right-12 top-3 z-0">
      <DropdownMenu>
